<form action="action_page.php">
  <div class="container">
    ...
    <input type="text" placeholder="Enter moible number2" name="mobile" id="mobile" required>
    <br>

    <label for="email"><b>Enter Email Address</b></label>
    <input type="text" placeholder="Enter Email Address2" name="email" id="email" required>
    <br>
